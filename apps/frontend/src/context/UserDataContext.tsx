...
// //   // 🔹 Load initial data from session/localStorage
// //   // useEffect(() => {
// //   //   const s = getSession();
// //   //   setPersonal({
...
// //   const demoPersonal: PersonalData = {
// //     pid_application_id: "APP-DEMO-001",
// //     pid_full_name: "Demo Tourist",
// //     pid_mobile: "9999999999",
// //     pid_email: "demo@safara.com",
// //     pid_personal_id: "PID-DEMO-1001",
// //     pid_nationality:"Indian",
// //   };

// //   const finalPersonal =
// //     savedPersonal.pid_full_name || savedPersonal.pid_mobile
// //       ? savedPersonal
// //       : demoPersonal;
...
// //   // Add DEMO tourist data if missing  
// //   const demoTourist: TouristData = {
// //     tid: "TID-DEMO-455",
// //     tid_status: "active",
// //     trip: {
...
// //   const finalTourist =
// //     savedTourist.tid || savedTourist.trip
// //       ? savedTourist
// //       : demoTourist;

// //   setTourist(finalTourist);

// //   // Save demo to localStorage so app stays stable
// //   if (!savedTourist.tid) {
// //     localStorage.setItem("current_tid", demoTourist.tid!);
// //     localStorage.setItem("current_tid_status", demoTourist.tid_status!);
// //     localStorage.setItem("trip_draft", JSON.stringify(demoTourist.trip));
// //   }

// // }, []);

// //   // 🔹 Update & Sync Personal Data
// //   const updatePersonal = (data: Partial<PersonalData>) => {
// //     setPersonal(prev => {
// //       const updated = { ...prev, ...data };
// //       for (const key in data) {
// //         if (data[key as keyof PersonalData] !== undefined)
// //           setUserItem(key, data[key as keyof PersonalData]);
// //       }
// //       return updated;
// //     });
// //   };

// //   // 🔹 Update & Sync Tourist Data
...
// //   // 🔹 Clear everything on logout/reset
// //   const clearAll = () => {
// //     setPersonal({});
// //     setTourist({});
