...
// //         const tourist = tourists.find(t => t.tid === alert.touristId);
...
// //       touristId: tourist?.tid,
// //       touristName: tourist?.pid_full_name,
// //       email: tourist?.pid_email,
// //       mobile: tourist?.pid_mobile,
// //       nationality: tourist?.pid_nationality,
...
// //     const tourist = tourists.find(t => t.tid === selectedAlert.touristId);
...
// //   //   const doc = new jsPDF();
// //   //   doc.setFontSize(16);
// //   //   doc.text("E-FIR (Electronic First Information Report)", 14, 20);
// //   //   doc.setFontSize(12);
// //   //   doc.text(`FIR ID: ${fir.id}`, 14, 30);
// //   //   doc.text(`Zone: ${fir.zoneName}`, 14, 38);
// //   //   doc.text(`Tourist Name: ${fir.touristName || "N/A"}`, 14, 46);
// //   //   doc.text(`Email: ${fir.email || "N/A"}`, 14, 54);
// //   //   doc.text(`Mobile: ${fir.mobile || "N/A"}`, 14, 62);
// //   //   doc.text(`Nationality: ${fir.nationality || "N/A"}`, 14, 70);
// //   //   doc.text(`Description:`, 14, 78);
// //   //   doc.text(fir.description, 14, 86, { maxWidth: 180 });
// //   //   doc.text(`Date/Time: ${new Date(fir.timestamp).toLocaleString()}`, 14, 110);
// //   //   doc.text(`Status: ${fir.status}`, 14, 118);
// //   //   doc.text("Generated electronically under Indian Tourism Department guidelines.", 14, 130);
